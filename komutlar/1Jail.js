...
exports.run = async (client, message, args) => {
  ...
  if(!message.member.roles.get("769603497544777762") && !message.member.hasPermission('ADMINISTRATOR')) return message.channel.send("Bu Komutu Kullanmaya Yetkin Yok!!").then(m => m.delete(5000));

  var user = message.guild.member(message.mentions.users.first() || message.guild.members.get(args[0]));

  var Karantina = message.guild.roles.get("767786546488672258")
...
var muteTime = args[1];
    ...
    let sChannel = message.guild.channels.get("767786819394863104")

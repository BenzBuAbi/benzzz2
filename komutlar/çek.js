...
exports.run = async (client, message, args) => {
  if(!message.member.roles.get("767786535926890516") && !message.member.hasPermission('ADMINISTRATOR')) return message.channel.send("Bu Komutu Kullanmaya Yetkin Yok!!").then(m => m.delete(5000));
